            ...
            @if ($selectedProxy !== 'NONE')
                <form wire:submit='submit'>
                    ...
                    <div class="pb-4 "> <svg class="inline-flex w-6 h-6 mr-2 dark:text-warning" viewBox="0 0 256 256"
                            ...
                            href="https://devlab.id/docs/knowledge-base/server/proxies#switch-between-proxies">this</a>.
                    </div>
                    <h4>Advanced</h4>
                    <div class="pb-4 w-96">
                        <x-forms.checkbox
                    ...
                    @endif
                    <x-forms.input placeholder="https://app.devlab.id" id="redirect_url" label="Default Redirect 404"
