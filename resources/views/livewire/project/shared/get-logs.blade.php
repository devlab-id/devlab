<div class="p-4 my-4 border dark:border-devgray-200">
    <div x-init="$wire.getLogs" id="screen" x-data="{
        ...
        <div :class="fullscreen ? 'fullscreen' : 'relative w-full py-4 mx-auto'">
            <div class="flex overflow-y-auto flex-col-reverse px-4 py-2 w-full bg-white dark:text-white dark:bg-devgray-100 scrollbar dark:border-devgray-300"
