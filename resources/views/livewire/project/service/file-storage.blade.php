<div class="py-4 ">
    <div class="flex flex-col justify-center pb-4 text-sm select-text">
        ...
        @if ($fileStorage->is_directory)
            <h4 class="dark:text-white pt-4 border-t dark:border-devgray-200">Directory Mount</h4>
        @else
            <h4 class="dark:text-white pt-4 border-t dark:border-devgray-200">File Mount</h4>
        @endif
