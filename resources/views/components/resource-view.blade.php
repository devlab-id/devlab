<div @class([
    'transition-all duration-150 box-without-bg dark:bg-devgray-100 bg-white group',
    'hover:border-ldevlab cursor-pointer' => !$upgrade,
    ...
    @isset($documentation)
        ...
        <div class="flex items-center px-2 " title="Read the documentation.">
            <a class="p-2 rounded hover:bg-devgray-200 hover:no-underline group-hover:dark:text-white text-neutral-600"
