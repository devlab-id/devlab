...
<div x-data="{
    ...
    <div
        class="flex flex-row items-center justify-between w-full h-full max-w-4xl p-6 mx-auto bg-white border shadow-lg lg:border-t dark:border-devgray-300 dark:bg-devgray-100 hover:dark:bg-devgray-100 lg:p-8 sm:rounded">
        <div
