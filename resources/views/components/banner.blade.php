...
<div x-data="{
    ...
    class="relative z-[999] w-full py-2 mx-auto duration-100 ease-out shadow-sm bg-devgray-100 sm:py-0 sm:h-14" x-cloak>
    <div class="flex items-center justify-between h-full px-3">
        {{ $slot }}
        @if ($closable)
            <button @click="bannerVisible=false"
                class="flex items-center flex-shrink-0 translate-x-1 ease-out duration-150 justify-center w-6 h-6 p-1.5 text-neutral-200 rounded-full hover:bg-devgray-500">
