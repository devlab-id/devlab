...
#[OA\Schema(
    ...
    properties: [
        ...
        'docker_compose' => ['type' => 'string', 'description' => 'The docker-compose.yml file that is parsed and modified by Devlab.'],
...
class Service extends BaseModel
{
    ...
    public function saveComposeConfigs()
    {
        ...
        $envs_from_devlab = $this->environment_variables()->get();
        $sorted = $envs_from_devlab->sortBy(function ($env) {
